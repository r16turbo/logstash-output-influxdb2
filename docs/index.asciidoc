...
| <<plugins-{type}s-{plugin}-include_tags>> |list of <<string,string>>|No
| <<plugins-{type}s-{plugin}-exclude_tags>> |list of <<string,string>>|No
...
[id="plugins-{type}s-{plugin}-include_tags"]
===== `include_tags`

  * Value type is a list of <<string,string>>
  * Default value is `[]`

An array of field names to include in the InfluxDB fields.
...
An array of field names to exclude from InfluxDB fields.
